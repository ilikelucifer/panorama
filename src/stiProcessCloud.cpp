...
bool StiProcess::processSingle(int idx)
{
	...
	ifstream fmapx(_camPath + "/sHDmapX_" + num2str<int>(idx + 1) + ".bin", std::ios::binary);
	if (fmapx.is_open())
	{
	...
	ifstream fmapy(_camPath + "/sHDmapY_" + num2str<int>(idx + 1) + ".bin", std::ios::binary);
	if (fmapy.is_open())
	{
...
bool StiProcess::calcBaseMaps()
{
	if (readCommonParams())
	{
		...
		//保存_map
		std::ofstream fmapx(_commonPath + "/HDmapX.bin", std::ios::binary | std::ios::trunc);
		fmapx.write((char*)HDmapX.data, sizeof(float)*HDmapX.rows*HDmapX.cols);
		fmapx.close();

		std::ofstream fmapy(_commonPath + "/HDmapY.bin", std::ios::binary | std::ios::trunc);
...
bool StiProcess::calcMapSingle(int idx)
{
	...
	ifstream fmapx(_commonPath + "/HDmapX.bin", std::ios::binary);
	if (fmapx.is_open())
	{
	...
	ifstream fmapy(_commonPath + "/HDmapY.bin", std::ios::binary);
	if (fmapy.is_open())
	{
	...
	//保存_map
	ofstream fmapxs(_camPath + "/sHDmapX_" + num2str<int>(idx + 1) + ".bin", std::ios::binary | std::ios::trunc);
	fmapxs.write((char*)sHDmapX.data, sizeof(float)*sHDmapX.rows*sHDmapX.cols);
	fmapxs.close();

	ofstream fmapys(_camPath + "/sHDmapY_" + num2str<int>(idx + 1) + ".bin", std::ios::binary | std::ios::trunc);
...
void StiProcess::one2sixMapping(InputArray srcImg, OutputArray dstImg, const string mapName)
{
	...
	imapx.open(_commonPath + "/map_" + mapName + "_x.bin", std::ios::binary);
	if (imapx.is_open())
	{
	...
	imapy.open(_commonPath + "/map_" + mapName + "_y.bin", std::ios::binary);
	if (imapy.is_open())
	{
...
#pragma omp parallel for schedule(dynamic)
	...
	fmapx.open(_commonPath + "/map_left_x.bin", std::ios::binary | std::ios::trunc);
	fmapx.write((char*)mapx.data, sizeof(float)*mapx.rows*mapx.cols);
	fmapx.close();

	fmapy.open(_commonPath + "/map_left_y.bin", std::ios::binary | std::ios::trunc);
...
#pragma omp parallel for schedule(dynamic)
	...
	fmapx.open(_commonPath + "/map_right_x.bin", std::ios::binary | std::ios::trunc);
	fmapx.write((char*)mapx.data, sizeof(float)*mapx.rows*mapx.cols);
	fmapx.close();

	fmapy.open(_commonPath + "/map_right_y.bin", std::ios::binary | std::ios::trunc);
	fmapy.write((char*)mapy.data, sizeof(float)*mapy.rows*mapy.cols);
	fmapy.close();
...
#pragma omp parallel for schedule(dynamic)
	...
	fmapx.open(_commonPath + "/map_top_x.bin", std::ios::binary | std::ios::trunc);
	fmapx.write((char*)mapx.data, sizeof(float)*mapx.rows*mapx.cols);
	fmapx.close();

	fmapy.open(_commonPath + "/map_top_y.bin", std::ios::binary | std::ios::trunc);
	fmapy.write((char*)mapy.data, sizeof(float)*mapy.rows*mapy.cols);
	fmapy.close();
...
#pragma omp parallel for schedule(dynamic)
	...
	fmapx.open(_commonPath + "/map_bottom_x.bin", std::ios::binary | std::ios::trunc);
	fmapx.write((char*)mapx.data, sizeof(float)*mapx.rows*mapx.cols);
	fmapx.close();

	fmapy.open(_commonPath + "/map_bottom_y.bin", std::ios::binary | std::ios::trunc);
	fmapy.write((char*)mapy.data, sizeof(float)*mapy.rows*mapy.cols);
	fmapy.close();
...
#pragma omp parallel for schedule(dynamic)
	...
	fmapx.open(_commonPath + "/map_front_x.bin", std::ios::binary | std::ios::trunc);
	fmapx.write((char*)mapx.data, sizeof(float)*mapx.rows*mapx.cols);
	fmapx.close();

	fmapy.open(_commonPath + "/map_front_y.bin", std::ios::binary | std::ios::trunc);
	fmapy.write((char*)mapy.data, sizeof(float)*mapy.rows*mapy.cols);
	fmapy.close();
...
#pragma omp parallel for schedule(dynamic)
	...
	fmapx.open(_commonPath + "/map_back_x.bin", std::ios::binary | std::ios::trunc);
	fmapx.write((char*)mapx.data, sizeof(float)*mapx.rows*mapx.cols);
	fmapx.close();

	fmapy.open(_commonPath + "/map_back_y.bin", std::ios::binary | std::ios::trunc);
	fmapy.write((char*)mapy.data, sizeof(float)*mapy.rows*mapy.cols);
	fmapy.close();
